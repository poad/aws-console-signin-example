...
export const appConfig: AppConfig = {
  ...
  protectedIdPName: process.env
    .NEXT_PUBLIC_AWS_PROTECTED_USER_IDP_NAME as string,
  groupRoleClassificationTagName:
    process.env.NEXT_PUBLIC_GROUP_ROL_CLASSIFICATION_TAG_NAME,
  groupRoleClassificationTagValue:
    process.env.NEXT_PUBLIC_GROUP_ROL_CLASSIFICATION_TAG_VALUE,
};
