...
const headCells = [
  {
    id: 'groupName' as TableHeadLabel,
    numeric: false,
    disablePadding: false,
    label: 'group name',
  },
  {
    id: 'description' as TableHeadLabel,
    numeric: false,
    disablePadding: false,
    label: 'description',
  },
  {
    id: 'precedence' as TableHeadLabel,
    numeric: false,
    disablePadding: false,
    label: 'precedence',
  },
  {
    id: 'creationDate' as TableHeadLabel,
    numeric: false,
    disablePadding: false,
    label: 'created at',
  },
  {
    id: 'lastModifiedDate' as TableHeadLabel,
    numeric: false,
    disablePadding: false,
            ...
            <TableRow>
              {headCells.map((headCell) => (
                <StyledTableCell
                  ...
                  sortDirection={
                    sortOrder.orderBy === headCell.id ? sortOrder.order : false
                  }
                >
